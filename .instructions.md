...
- **Exception classes** (e.g., `SomethingWentWrongException`) — exercised transitively by dw4-app and spring3-app tests
- **`MetricsResponse`** — exercised by dw4-app and spring3-app tests
- **Spring `main()` method** (`Spring3Application.main`) — boot wiring covered by `@SpringBootTest` integration tests
