...
- **Exception classes** (e.g., `SomethingWentWrongException`) — trivial subclasses exercised transitively by app-module tests; JaCoCo cannot measure cross-module coverage
- **`MetricsResponse`** — same cross-module measurement issue; fully exercised by dw4-app and spring3-app tests
