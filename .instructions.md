...
## Key Information
- **Language**: Java 21
- **Framework**: Dropwizard 4.0.15
- **Architecture**: Microservice with REST API
- **Testing Framework**: JUnit 5.13.4 with Mockito 5.18.0, Rest Assured 5.3.2 for integration tests
- **Code Quality**: Spotless 2.46.1 for formatting, JaCoCo 0.8.13 for coverage, SpotBugs 4.9.3.2 with FindSecBugs 1.14.0 for security analysis
- **Architecture Testing**: ArchUnit 1.2.1 for enforcing architectural constraints
- **Libraries**: Lombok 1.18.32 for reducing boilerplate code, AssertJ 3.27.4 for fluent assertions, Awaitility 4.3.0 for async testing
...
mvn test -Dtest="com.example.dw.architecture.*"
...
# Use convenience script (alternative to agent)
...
# Generate SpotBugs report with security findings
