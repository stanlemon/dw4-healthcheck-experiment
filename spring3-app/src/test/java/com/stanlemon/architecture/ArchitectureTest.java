...
class ArchitectureTest {
  ...
  static void setup() {
    importedClasses =
        new ClassFileImporter()
            ...
            .importPackages("com.stanlemon.healthy.spring3app");
  }
  ...
  @Test
  @DisplayName("Exception handlers should reside in exceptions package")
  void exceptionHandlersShouldResideInExceptionsPackage() {
    ArchRule rule =
        classesWithNameShouldBeInPackage(
            ".*ExceptionHandler",
            "..exceptions..",
            "Exception handlers should be organized in the exceptions package");
    rule.check(importedClasses);
  }
  ...
  void resourcesShouldBeRestControllers() {
    ArchRule rule =
        classes()
            ...
            .because("Resource classes should be REST controllers with RestController annotation");
  ...
  void noCircularDependenciesBetweenPackages() {
    ArchRule rule = noCircularDependencies("com.stanlemon.healthy.spring3app.(*)..");
    rule.check(importedClasses);
  }
